...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-end pb-24 md:pb-40 overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-background via-background/40 to-transparent dark:via-background/70 dark:to-background/30" />
        <div className="absolute inset-0 bg-gradient-to-r from-background/50 via-background/20 to-transparent dark:from-background/80 dark:via-background/40" />
      </div>
